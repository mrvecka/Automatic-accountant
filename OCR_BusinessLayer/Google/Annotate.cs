...
namespace OCR_BusinessLayer.Google
{
    public class Annotate
    {
        ...
        public AnnotateImageResponse Response { get; set; }
        ...
        private GoogleCredential CreateCredential()
        {
            ...
            using (var stream = new FileStream(@"C:\Users\Lukáš\source\repos\Bakalarska_praca\OCR_BusinessLayer\lib\GoogleVision\OCR Api 1-fd24826faf62.json", FileMode.Open, FileAccess.Read))
            {
